...
public class BestMoleculesPickerFromLCMSIonAnalysis {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Map<String, String> nameToInchi = new HashMap<String, String>() {{
      ...
      put("emtricitabine-2'-o-glucuronide","InChI=1S/C14H18FN3O9S/c15-4-1-18(14(24)17-11(4)16)5-3-28-6(26-5)2-25-13-9(21)7(19)8(20)10(27-13)12(22)23/h1,5-10,13,19-21H,2-3H2,(H,22,23)(H2,16,17,24)/t5-,6+,7-,8-,9+,10-put(",13+/m0/s1");
