...
public class WriteAndPlotMS1Results {
  ...
  public static List<String> writeFeedMS1Values(List<Pair<Double, List<XZ>>> ms1s, Double maxIntensity,
  ...
  public static void writeFeedMS1Values(List<Pair<Double, Double>> concentrationIntensity, OutputStream os)
      throws IOException {
    PrintStream out = new PrintStream(os);
