...
public class ROUCSToKnown extends UniformCostSearch<SimplifiedUCSNode> {
	private Chemical goal;
	private Set<Long> startingChemicals;
	private SimplifiedReactionNetwork srn;
	
	private Set<Long> ignore;
	private ActAdminServiceImpl actServer;
	public ROUCSToKnown(SimplifiedReactionNetwork srn, Set<Long> startingChemicals) {
		this.srn = srn;
