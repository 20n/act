...
object cascades {
  ...
  def write_node_cascades(p: String, depth: Integer, outputDirectory: String) {
    ...
    val reach: List[Long] = List(475L, 878L, 1209L, 552L, 716L, 475L, 4026L, 750L, 1536L, 1490L, 1496L, 341L, 448L, 1293L, 1443L, 45655, 19637L, 684L, 358L, 2124L, 6790L) ::: reachables
